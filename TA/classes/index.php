          ...
          <div class="home-widgets">
                ...
                <div class="home-group5">
                  ...
                  <span class="home-text06">
                    <?php
                      ...
                      $count = "SELECT COUNT(DISTINCT(studentID)) FROM logs WHERE classID in (SELECT classID from classlist WHERE taID=$profid)";
                      $stmt = $db->query($count);
            ...
            <div class="home-frame107">
              <div class="home-frame108">
                        <?php  
                      $classlist = "SELECT classID, class FROM classlist WHERE taID=$profid";
                      $classidlist = "SELECT classID FROM classlist WHERE taID=$profid";
